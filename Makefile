.PHONY: help doctor dev setup start stop check check-full gate db-up db-down db-reset worktree-env setup-worktree start-worktree stop-worktree check-worktree server web build test test-go test-fe e2e migrate-up migrate-down sqlc clean
