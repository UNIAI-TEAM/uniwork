...
var catalogue = []Flag{
	...
	{Key: "home_page", Description: "Trang chủ ở gốc workspace: việc của tôi, sắp tới, hộp việc, tóm tắt hôm nay (A-05)", Default: false, Public: true, Owner: "insights", ReviewAt: day(2026, 12, 31)},
