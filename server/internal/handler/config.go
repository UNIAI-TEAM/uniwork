...
// signed in, optionally in an organization) and the RUM sample rate. Flags
// never grant anything — permission stays in the services — so the
// organization id in the query is trusted as a targeting hint only.
