...
func button(href, label string) htmltemplate.HTML {
	...
	return htmltemplate.HTML(`<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="` + h + `" style="height:48px;v-text-anchor:middle;width:240px" arcsize="21%" stroke="f" fillcolor="#0a52e6"><w:anchorlock/><center style="color:#ffffff;font-family:'Segoe UI',Arial,sans-serif;font-size:15px;font-weight:600">` + l + `</center></v:roundrect><![endif]-->` +
		`<!--[if !mso]><!--><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td style="background:#0a52e6;border-radius:10px"><a href="` + h + `" style="display:inline-block;padding:14px 24px;font-size:15px;line-height:20px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:10px">` + l + `</a></td></tr></table><!--<![endif]-->`)
}
