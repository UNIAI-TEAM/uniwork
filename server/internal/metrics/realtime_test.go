...
func TestRealtimeCollectorExposesCounters(t *testing.T) {
	...
	for _, want := range []string{
		"uniwork_realtime_active_connections 3",
		"uniwork_realtime_messages_sent_total 11",
		"uniwork_realtime_inbound_too_large_total 7",
		"uniwork_realtime_redis_connected 1",
		`uniwork_realtime_redis_mirror_errors_total{target="primary"} 2`,
		`uniwork_realtime_redis_mirror_errors_total{target="secondary"} 5`,
	} {
