...
> **Trạng thái:** shipped · **Cập nhật:** 2026-09-16 · Bản chốt của 11 key point sản phẩm, kèm đối chiếu với Vision, Roadmap và spec để không có key point nào "chỉ nằm trong slide".
...
| --- | --- | --- | --- | --- |
| 1 | **One Workspace for Work** | Project, Task, Meeting, Document, Kết quả công việc, Chat, Email, People, Knowledge, Decision trong một workspace | Vision §5.2 (19 bounded context); Email là tích hợp Gmail/Microsoft, không phải hộp thư riêng; Decision là Decision record, không phải hub; Kết quả công việc là deliverable nghiệp vụ, Document là kho của nó (ADR 0016) | F-05, F-06, F-12, F-03, C-01, C-14, C-12, A-04, A-10 |
...
| 9 | **Work Contract / Sell Work Foundation** | Mỗi loại công việc có contract: input, context, executor, action, deliverable, acceptance, quality, review, SLA | `work_contracts` (spec agent §4.3) có từ A-01; A-09 "Bán công việc" chỉ thêm cohort, định giá, catalog. **Đây là hợp đồng của một *loại* việc, không phải deliverable** — deliverable là key point 1 và C-14 | A-01, A-09 |
...
| 11 | **From Software to Work** | Không chỉ bán seat mà tiến tới Work-as-a-Service, khách mua kết quả công việc | Vision §4.2 lớp doanh thu "Bán công việc"; chỉ công bố khi cohort PROVEN | A-09 |
...
- Key point 9 (2026-09-16): "Work Product / Sell Work Foundation" → "Work Contract /
  Sell Work Foundation", và A-09 đổi tên thành "Bán công việc". Lý do: từ 2026-09-16
  "Work Product" mang nghĩa **deliverable nghiệp vụ** (bounded context mới, §5.2 mục 19,
  ADR 0016). Giữ tên cũ ở key point 9 sẽ khiến hai khái niệm khác hẳn nhau dùng chung
  một chữ trong cùng một trang.
