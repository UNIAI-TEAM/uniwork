...
| C-08 | Mobile PWA | `_authenticated/m.tsx`, `m/*`, `public/manifest`, `src/components/mobile/*` | `push-client.ts` | `docs/product/UNIWORK_INFORMATION_ARCHITECTURE_V2.md` §3, `.lovable/plan/uniwork-mobile-pwa-*.md` | 5 tab, More page theo IA |
