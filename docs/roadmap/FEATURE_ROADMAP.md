...
| F-05 | Tasks Work Management parity: Tasks, My Tasks, Projects, năm views, collaboration, web/desktop/mobile và integration stubs | Project & Task | MỘT PHẦN | Slice 1/UNI-495 foundation + Slice 2/UNI-497 API+client core + Slice 3/UNI-500 collection surfaces shipped (flag-gated Task Surface: 5 modes, filters, saved views, `/my-tasks` scopes). Còn Projects UI / detail / hosts / cutover | `2026-09-07-tasks-work-management-parity-design.md` | P0 |
