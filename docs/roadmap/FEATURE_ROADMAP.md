...
| F-05 | Tasks Work Management parity: Tasks, My Tasks, Projects, năm views, collaboration, web/desktop/mobile và integration stubs | Project & Task | MỘT PHẦN | Slice 1/UNI-495 foundation + Slice 2/UNI-497 API+client core + Slice 3/UNI-500 collection surfaces + Slice 4/UNI-502 Projects suite + Slice 5/UNI-505 Task detail & collaboration shipped (flag-gated suite detail + TipTap editor + attachments + timeline stubs). Còn agent-integration / hosts / cutover (lát 6–8); residual optional `project_id` on create-from-project | `2026-09-07-tasks-work-management-parity-design.md` | P0 |
