...
| F-05 | Tasks Work Management parity: Tasks, My Tasks, Projects, năm views, collaboration, web/desktop/mobile và integration stubs | Project & Task | MỘT PHẦN | Clone theo baseline `3d37828e9`; migration in-place, capability thiếu hiện disabled | `2026-09-07-tasks-work-management-parity-design.md` | P0 |
