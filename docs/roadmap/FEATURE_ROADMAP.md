...
| F-05 | Tasks Work Management parity: Tasks, My Tasks, Projects, năm views, collaboration, web/desktop/mobile và integration stubs | Project & Task | MỘT PHẦN | Slice 1/UNI-495 foundation + Slice 2/UNI-497 API+client core shipped (flag-gated suite, catalogue, revision/idempotency, core endpoints/hooks/realtime; UI unchanged). Còn slices UI/collection/Projects surfaces/desktop/mobile | `2026-09-07-tasks-work-management-parity-design.md` | P0 |
...
| --- | --- | --- | --- | --- | --- |
| C-01 | Documents: soạn thảo cộng tác, phiên bản, chia sẻ, nhật ký truy cập, object storage | Document | CHƯA | `2026-09-08-documents-design.md` (đề xuất, chờ duyệt — UNI-437) | P0 |
