...
**Spec:** [Documents + Office G0](../../superpowers/specs/2026-09-16-documents-office-g0-design.md) §2.1, §8.1.
...
| B-08 | Icon / app icon / installer icon | `apps/shell/build/`, `src/renderer/src/assets/` | Bộ icon UniWork (xem `packages/ui/brand/` làm nguồn thiết kế) | G3, G4 | Screenshot icon trên taskbar/Dock/installer |
