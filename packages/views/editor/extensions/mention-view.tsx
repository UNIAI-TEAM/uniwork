 ...
 * Task/project mentions render the same navigable chips as readonly content
 * (TaskMentionCard / ProjectMentionCard), so click behavior — plain click,
 ...
 * click alone.
 *
 * Task chip sizing: must fit within the paragraph line box (14px * 1.625 =
...
import { TaskMentionCard } from "../stubs/task-mention-card";
import { ProjectMentionCard } from "../stubs/project-mention-card";
...
export function MentionView({ node }: NodeViewProps) {
  ...
  if (type === "issue") {
    return (
      ...
      >
        <TaskMentionCard issueId={id} fallbackLabel={label} />
      </NodeViewWrapper>
    );
  }
