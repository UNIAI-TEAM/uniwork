...
const MERMAID_LAYOUT_CACHE_PREFIX = "uniwork:mermaid:layout:";
...
function useTranslationhemeVersion() {
...
export function MermaidDiagram({ chart }: { chart: string }) {
  ...
  const themeVersion = useTranslationhemeVersion();
    ...
    return (
      <div ref={containerRef} className="mermaid-diagram mermaid-diagram-error">
        <div className="mermaid-diagram-error-head">
          <p>{t("editor.mermaid.render_error")}</p>
          <button
            type="button"
            onClick={handleCopySource}
            title={t("editor.mermaid.copy_source")}
            aria-label={t("editor.mermaid.copy_source")}
          >
  ...
  return (
    ...
    >
      {rendered ? (
        <>
          ...
          <div className="mermaid-diagram-toolbar">
            ...
            <button
              ...
              title={t("editor.mermaid.open_viewer")}
              aria-label={t("editor.mermaid.open_viewer")}
            >
        ...
        <div className="mermaid-diagram-loading">{t("editor.mermaid.rendering")}</div>
      )}
    </div>
  );
}
