...
// consumers are no longer only editor pickers: the task detail's thread
 ...
 * muscle memory (UNI-3685). `Shift+Tab` and any `Ctrl/Cmd/Alt + Tab` are
 ...
 * rule `isReservedShortcut` in `@uniwork/core/shortcuts` already encodes.
 *
