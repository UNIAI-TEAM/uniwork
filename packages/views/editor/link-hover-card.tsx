...
function LinkHoverCard({
  ...
  const setCardRef = useCallback(
    (node: HTMLDivElement | null) => {
      ...
      void computePosition(anchorEl, node, {
  ...
  const handleCopy = async (e: React.MouseEvent) => {
    ...
    if (await copyText(href)) {
      toast.success(t("editor.link_hover.link_copied"));
    } else {
      toast.error(t("editor.link_hover.copy_failed"));
    }
  };
  ...
  return createPortal(
    ...
    >
      ...
      <Button
        ...
        onClick={handleCopy}
        title={t("editor.link_hover.copy_link")}
      >
      ...
      <Button
        ...
        className="text-muted-foreground"
        onClick={handleOpen}
        title={t("editor.link_hover.open_link")}
      >
