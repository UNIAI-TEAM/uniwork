...
export function emailHubNavItemClass(active: boolean) {
  return cn(
    "flex min-h-11 w-full items-center gap-2.5 rounded-xl px-3 py-2 text-body text-muted-foreground transition-[background-color,color]",
...
export function emailHubAccountRowClass(active: boolean) {
  return cn(
    "min-w-0 flex-1 truncate rounded-xl border border-transparent px-3 py-2.5 text-left text-caption transition-[background-color,border-color,color]",
...
export const emailHubIconActionClass =
  "inline-flex size-9 shrink-0 items-center justify-center rounded-xl text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground disabled:opacity-50";

export const emailHubToolbarShellClass =
  "flex flex-wrap items-center gap-1 rounded-xl border border-border/50 bg-muted/25 p-1";
...
export const emailHubComposeButtonClass = "h-10 w-full justify-start gap-2 rounded-xl shadow-none";

export const emailHubSecondaryNavButtonClass =
  "h-9 w-full justify-start gap-2 rounded-xl border-dashed border-border/80 bg-transparent text-muted-foreground shadow-none hover:bg-muted/30";
