/**
 * The one place a mouse event is mapped to a navigation intent:
 *
 ...
 * to "push". On web, a real anchor leaves any modified click to the browser —
 * native handling is the only way to get a true background tab.
 */
...
export function resolveClickIntent(
  ...
  if (e.metaKey || e.ctrlKey) return e.shiftKey ? "foreground-tab" : "background-tab";
  return "push";
}
