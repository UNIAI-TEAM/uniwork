    ...
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      {isError ? (
        <CollectionPageState
          ...
          actions={
            <Button size="sm" variant="outline" className="pointer-coarse:h-11" onClick={() => void refetch()}>
              {t("common.retry")}
            </Button>
          }
        />
          ...
          <div className={COLUMN}>
            ...
            {data === undefined ? (
              ...
              <CollectionPageState
                ...
                actions={
                  <Button size="sm" variant="outline" className="pointer-coarse:h-11" onClick={resetFilters}>
