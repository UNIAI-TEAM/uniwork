...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // `pointer-coarse:min-h-11` and not `h-11`: the sizes below are written
        // as `data-[size=…]:h-8`, an attribute selector that outranks any plain
        // height utility a caller passes through `className`, so the call site
        ...
        variant === "default"
          ...
          : "border-border bg-surface-hover/60 hover:bg-surface-hover",
        className
      )}
      {...props}
    >
