...
import { SelectTrigger } from "@uniwork/ui/components/ui/select"
...
function InputGroupAddon({
  ...
  return (
    // onMouseDown only guards focus (see below); it is not an action, so no
