    ...
    <PopoverPrimitive.Portal keepMounted={keepMounted}>
      ...
      >
        <PopoverPrimitive.Popup
          ...
          className={cn(
            "z-50 flex w-72 flex-col gap-2.5 rounded-lg bg-surface-raised p-2.5 text-body text-popover-foreground shadow-[var(--menu-shadow)] ring-1 ring-surface-border outline-hidden",
