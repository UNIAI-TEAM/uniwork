  ...
  return (
    <OTPInput
      ...
      containerClassName={cn(
        // `group/otp` lets the slots react to the hidden input's aria-invalid,
        // which sits beside the group rather than inside it.
