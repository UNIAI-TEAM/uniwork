 ...
 * preview viewer's prev / next navigation (UNI-5752).
 *
 ...
 *
 * The sequence is built from DATA, not from the DOM: both the task timeline
 ...
 * apps/mobile/CLAUDE.md: pure functions from @uniwork/core are importable).
 */
 ...
 *      that every post-UNI-3130 body persists. Survives a host swap and any
...
/** One renderable unit: an task description, a comment, a chat message. */
