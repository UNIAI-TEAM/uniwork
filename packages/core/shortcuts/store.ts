...
export const useShortcutStore = create<ShortcutState>()(
  persist(
    (set) => ({
      ...
      setShortcut: (actionId, shortcut) =>
        set((state) => {
          ...
          if (shortcutChordEquals(shortcut, SHORTCUT_ACTION_BY_ID[actionId]?.defaultShortcut ?? null)) {
    ...
    {
      name: "uniwork_keyboard_shortcuts",
...
export function resolveShortcut(
  ...
  return Object.prototype.hasOwnProperty.call(overrides, actionId)
    ...
    : (SHORTCUT_ACTION_BY_ID[actionId]?.defaultShortcut ?? null);
}
